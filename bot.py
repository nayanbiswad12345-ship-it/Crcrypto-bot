...
# --- Configuration ---
TELEGRAM_TOKEN = "8790408553:AAGSqfM_QCW_68ha2s0WDQKRaxPaKU8YWI8"
CHAT_ID = "8637317407"
SYMBOL = "BTCUSDT"
INTERVAL = "5m"
...
def check_market():
  ...
  # Analyzing the latest confirmed closed candle (index -2) and previous candle (index -3)
  ...
  bullish_engulfing = (
      is_green and prev_is_red and bullish_engulfs and touching_bull
  )
  ...
  bearish_engulfing = (
      is_red and prev_is_green and bearish_engulfs and touching_bear
  )

  # Send Telegram Alerts based on conditions
